...
<html>
	...
	<body>
		...
		<div id="edit-catering" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:cateringInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${cateringInstance?.version}" />
				<fieldset class="form">
